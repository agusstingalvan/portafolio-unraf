...
export default class Nivel1 extends Phaser.Scene {
  ...
  create() {
    ...
    map.createLayer("Cielo", tiledBackgrounds, 0, 0);
    const plataformas = map.createLayer("Plataformas", tiledPlataformas, 0, 0);
    ...
    // tiles marked as colliding
        ...
        // plataformas.renderDebug(debugGraphics, {
    ...
    objectsLayer.objects.forEach((objData) => {
      ...
      switch (type) {
        case "zanahorias": {
          ...
          zanahoria.setCollideWorldBounds(true);
          break;
        }
      }
    });
    this.physics.add.collider(this.zanahorias, plataformas);
